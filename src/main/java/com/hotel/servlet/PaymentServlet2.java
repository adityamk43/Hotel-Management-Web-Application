...
public class PaymentServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String CardExpDate = request.getParameter("Expiry");
            String CardName = request.getParameter("nameCard");
            ...
            if (guest.getGid() == 0) {
                ...
                if (bdao.saveBookingData(guest, booking, category)) {
                    ...
                    Payment payment = new Payment(booking.getBid(), PaymentMethod2, CardNumber, CardExpDate, CardName);

                    if (pdao.InsertPaymentDetails2(payment, booking)) {
