...
//            this.container.find('.drp-selected').html(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format));
            this.container.find('.drp-selected').html('<strong>From ' + this.startDate.format('MMMM DD YYYY') + ' To ' + this.endDate.format('MMMM DD YYYY') + '</strong>');
...
//            $('#roomcolumn').removeClass('col-sm-8');
//            $('#roomcolumn').addClass('col-sm-12');
